...
void main() {
  patrolTest('profile_flow_opens_editor_and_back_returns_home', ($) async {
    ...
    // Assert 2: the RECORD group's best-time card renders (§ 9
    // anchor; dash or value — the record itself is not asserted,
    // device state persists across runs). Exists (not strict
    // visibility): the RECORD group sits below the fold on small
    // viewports and ListView cacheExtent keeps it off the
    // hit-testable area.
    await $('BEST TIME').waitUntilExists();
