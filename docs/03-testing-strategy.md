...
- **Wall-clock carve-out (Patrol only)**: `DateTime.now` deadline loops inside patrol tests are permitted — the test host runs in real device time; Law § 10.2.5 targets in-process test clocks.
