...
TongTong Royal is a Fall Guys-benchmarked show: qualification rounds 4→3→2(–3)→1 crown, one-button controls, vs bots (multiplayer infra preserved for online shows). Full rules: `docs/01-game-design.md`.
